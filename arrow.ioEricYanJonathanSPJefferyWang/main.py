"""
Arrow.IO
Created by Eric Yan, Jeffery Wang, Jonathan Sun-Payeur
...
class Enemy(pygame.sprite.Sprite):
    ...
    def move_to_next_point(self, point):
        ...
        dx = point[0] * 20 - self.rect.center[0]
...
class Info():  # The area on the right that contains the player stats, arrow menu and shop
    def __init__(self):
        ...
        self.shop_lock = pygame.image.load('data/image/shop_lock.png')
        self.coins = pygame.image.load('data/image/coins.png')
        self.default = pygame.image.load('data/image/skins/default/aiming_0.png')
        self.black = pygame.image.load('data/image/skins/black/aiming_0.png')
        self.desert = pygame.image.load('data/image/skins/desert/aiming_0.png')
    ...
    def SHOP_display(self):
        ...
        screen.blit(self.coins, (1030, 127))
...
class Display():
    ...
    def pausegame_display(self, x, y):
        ...
        # Takes in mouse x and y coordinates for button click
        global pausegame
        if x in range(1061, 1083) and y in range(715, 746) and mouse_pressed == (1, 0, 0):
...
def all_update():  # All the necessary updates when the game is running
    ...
    screen.blit(pause_button, (1052, 715))
